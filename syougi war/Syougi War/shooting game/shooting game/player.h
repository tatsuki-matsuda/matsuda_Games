...
public:
	...
	PLAYERSTATE GetPlayerState(void) { return m_PlayerState; }						//状態情報の呼び出し
	void SetPlayerState(PLAYERSTATE playerState) { m_PlayerState = playerState; }	//状態情報の取得
...
private:
	...
	int   m_nCntBomb = 200;											// ボム発動カウント
	int   m_nCntUse;												// ボム発動量カウント
